...
![Prof. Josh Brake](images/brake.png){text-align=" width="150px"}

![Prof. Dre Helmns](images/helmns.png){width="150px"}

![Prof. Qimin Yang](images/yang.png){width="150px"}
...
| Monday    | Noon (Canvas) |                      |              |                                 |
| Tuesday   |                           | 5:15p (E80-1) |              |                                 |
| Wednesday |                           | 5:15p (E80-2) |              |                                 |
| Thursday  |                           | 5:15p (E80-3) |              |                                 |
| Friday    |                           |                      | 3:15p | 3:30p                    |
...
::: incremental
- You must submit **something** by the deadline. Don't phone this in because there is limited time for resubmission.
- After you receive feedback, you can revise your submissions and resubmit during the week before spring break. Most of specs can be done outside of lab with data. However, if you weren't able to get good data, there is one week before spring break where you can go back to collect more.
...
Join us for a social in the Hixon Courtyard by the Koi pond with snacks and mingle with your peers, the E80 teaching team, and some engineering juniors and seniors.